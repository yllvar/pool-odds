...
import { realDLMMService } from "./dlmm-real"
...
// Main DLMM service that delegates to the Meteora-integrated implementation
export const dlmmService = USE_REAL_SDK ? DLMMService.getInstance() : meteoraIntegratedDLMM
